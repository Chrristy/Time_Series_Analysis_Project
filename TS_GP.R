...
# Conclusion: p-value = 0.8711 > 0.05, snap_ts is non-stationary.
...
test_data <- subset(snap_ts, start = train_size + 1)
...
fit_lm <- lm(as.numeric(train_data) ~ train_time)
...
plot(fc_arima, main="SNAP Stock Forecast Comparison", 
